...
from solver.loss_image_state import LossImageState, MultiLossImageState
...
def training_loss(iteration, opt, viewpoint_cam, gaussians, pipe, bg, train_test_exp,
    ...
    loss_per_pixel = torch.cat((Ll1_per_pixel.flatten(), 
                                ssim_loss_per_pixel.flatten(),
                                Ll1depth_per_pixel.flatten()), dim=0)
